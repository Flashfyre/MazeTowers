 ...
 */
public class HiddenPressurePlateWeightedModel implements
	ISmartBlockModel {
	...
	public IBakedModel handleBlockState(
		...
		IBlockState baseState = Blocks.heavy_weighted_pressure_plate
			.getStateFromMeta(iBlockState
				.getValue(BlockHiddenPressurePlateWeighted.POWER) == 0 ? 0
				: 1);
	...
	public TextureAtlasSprite getTexture() {
		return (copyBakedModel == null || copyBakedModel
			.getTexture().getIconName().equals("missingno")) ? baseBakedModel
			.getTexture()
			: copyBakedModel.getTexture();
	}
