...
public class TileEntityBlockProtect extends TileEntity
	...
	public boolean shouldRefresh(World world, BlockPos pos,
		...
		final boolean shouldRefresh = super.shouldRefresh(
	...
	@Override
	public void update() {
		if (this.worldObj.getBlockState(this.pos) == Blocks.air
			.getDefaultState()) {
