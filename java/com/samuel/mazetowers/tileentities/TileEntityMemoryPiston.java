...
public class TileEntityMemoryPiston extends TileEntity implements ITickable {
    ...
    public TileEntityMemoryPiston(IBlockState pistonStateIn, EnumFacing pistonFacingIn, boolean extendingIn, boolean shouldHeadBeRenderedIn)
    {
    ...
    private void launchWithSlimeBlock(float p_145863_1_, float p_145863_2_)
    {
        ...
        AxisAlignedBB axisalignedbb = ((BlockMemoryPistonMoving) MazeTowers.BlockMemoryPistonExtension)
        	.getBoundingBox(this.worldObj, this.pos, this.pistonState, p_145863_1_, this.pistonFacing);
