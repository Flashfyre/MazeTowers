...
public class EntityExplosiveArrow extends EntityArrow {
	    ...
	    public void onCollideWithPlayer(EntityPlayer entityIn)
	    {
	        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
	        {
	            ...
	            if (this.canBePickedUp == 1 && !entityIn.inventory.addItemStackToInventory(new ItemStack(MazeTowers.ItemExplosiveArrow, 1)))
	            {
	                flag = false;
	            }
	    ...
	    public void onUpdate()
	    {
	        ...
	        if (this.inGround)
	        {
	            ...
	            if (block == this.inTile && j == this.inData)
	            {
	                ...
	                if (this.ticksInGround == 1) {
	 	                this.worldObj.playSoundAtEntity(this, "mazetowers:primed", 1.0F, 0.9F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.15F);    
	                } else if (this.ticksInGround == 25 && !this.worldObj.isRemote) {
	                	this.worldObj.newExplosion(this, this.posX, this.posY + (double)(this.height / 2.0F), this.posZ,
	                		2.0F, false, true);
	                	this.setDead();
	                }
	            }
	        ...
	        else
	        {
	            ...
	            if (movingobjectposition != null)
	            {
	                if (movingobjectposition.entityHit != null && (this.ticksExisted > 5 || movingobjectposition.entityHit != this.shootingEntity))
	                {
