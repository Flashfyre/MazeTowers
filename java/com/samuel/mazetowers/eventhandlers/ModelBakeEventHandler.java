...
/**
 * Created from Camouflage Block ModelBakeEventHandler created by TheGreyGhost on 19/04/2015.
 */
public class ModelBakeEventHandler {
  ...
  {
	  Object plateObj = event.modelRegistry.getObject(HiddenPressurePlateWeightedModel.modelResourceLocationUp);
	  Object buttonObj = event.modelRegistry.getObject(HiddenPressurePlateWeightedModel.modelResourceLocationUp);  
	  ...
	  if (plateObj instanceof IBakedModel) {
	      ...
	      try {
	    	  modelPlateUp = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("block/heavy_pressure_plate_up"));
	    	  modelPlateDown = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("block/heavy_pressure_plate_down"));
	      } catch (IOException e) {
	    	  e.printStackTrace();
	      }
	  ...
	  if (buttonObj instanceof IBakedModel) {
	      ...
	      try {
	    	  modelButtonU = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_u"));
	    	  modelButtonD = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_d"));
	    	  modelButtonE = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_e"));
	    	  modelButtonW = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_w"));
	    	  modelButtonS = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_s"));
	    	  modelButtonN = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_n"));
	    	  modelButtonUPressed = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_u_pressed"));
	    	  modelButtonDPressed = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_d_pressed"));
	    	  modelButtonEPressed = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_e_pressed"));
	    	  modelButtonWPressed = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_w_pressed"));
	    	  modelButtonSPressed = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_s_pressed"));
	    	  modelButtonNPressed = (IRetexturableModel) event.modelLoader.getModel(new ResourceLocation("mazetowers:block/quartz_button_n_pressed"));
		} catch (IOException e) {
			e.printStackTrace();
		}
