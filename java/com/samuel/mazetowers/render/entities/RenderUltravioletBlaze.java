...
public class RenderUltravioletBlaze extends RenderBlaze {
	...
	private static final ResourceLocation blazeTextures = new ResourceLocation("mazetowers:textures/entities/ultravioletblaze.png");

    public RenderUltravioletBlaze(RenderManager renderManagerIn)
    {
     ...
     */
    protected void renderModel(EntityBlaze entitylivingbaseIn, float p_77036_2_,
    	float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_,
    	float p_77036_7_)
    {
