...
public class TileEntityRedstoneClockRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity te, double dx, double dy, double dz,
		...
		if (renderManager == null) {
			final ItemStack stackNormal = new ItemStack(Item.getItemFromBlock(ModBlocks.redstone_clock)),
			stackInverted = new ItemStack(Item.getItemFromBlock(ModBlocks.redstone_clock_inverted));
    	...
    	renderManager.renderEntityWithPosYaw(entity, 0.25D, -0.1D, -0.0125D, 0.0F, 0.0F);
