...
public class BlockMemoryPistonStructureHelper
{
    ...
    public BlockMemoryPistonStructureHelper(World worldIn, BlockPos posIn, EnumFacing pistonFacing, boolean extending)
    {
        this.world = worldIn;
    ...
    public boolean canMove(int pushCount)
    {
        ...
        if (!BlockMemoryPistonBase.canPush(block, this.world, this.blockToMove, this.moveDirection, false))
        {
    ...
    private boolean func_177251_a(BlockPos origin, int pushCount)
    {
        ...
        else if (!BlockMemoryPistonBase.canPush(block, this.world, origin, this.moveDirection, false))
        {
            return true;
        }
        ...
        else
        {
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    if (!BlockMemoryPistonBase.canPush(block, this.world, blockpos1, this.moveDirection, true) ||
