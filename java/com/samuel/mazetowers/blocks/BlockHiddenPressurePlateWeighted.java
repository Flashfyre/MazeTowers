 ...
 */
public class BlockHiddenPressurePlateWeighted extends
	...
	private boolean canBePlacedOn(World worldIn,
		BlockPos pos) {
			...
			.min(
				worldIn
					.getEntitiesWithinAABB(
						(isMTPFallTrap(worldIn, pos) ? EntityLivingBase.class
							: Entity.class),
						this.getSensitiveAABB(pos)).size(),
				this.field_150068_a);
	...
	private IBlockState getMTPFallTrapPistonState(
	...
	private boolean isMTPFallTrap(World worldIn,
		BlockPos pos) {
	...
	private IBlockState getBelowState(IBlockAccess world,
		BlockPos blockPos) {
