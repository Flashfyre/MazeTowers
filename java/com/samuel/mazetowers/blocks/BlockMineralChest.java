            ...
            else
            {
                ...
                while (iterator.hasNext())
                {
                    ...
                    if (block == this)
                    {
                        ...
                        {
                        	String containerName = "Double " + ((TileEntityMineralChest) tileentity1)
                        		.getDisplayName().getUnformattedText();
                            if (enumfacing != EnumFacing.WEST && enumfacing != EnumFacing.NORTH)
                            {
                                object = new InventoryLargeMineralChest(containerName, (ILockableContainer)object, (TileEntityMineralChest)tileentity1);
                            }
                            else
                            {
                                object = new InventoryLargeMineralChest(containerName, (TileEntityMineralChest)tileentity1, (ILockableContainer)object);
                            }
                        }
                    }
                }
